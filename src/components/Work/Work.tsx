...
export const ExportMetadata: React.FunctionComponent<Props> = ({ doi }) => {
...
const DoiPresentation: React.FunctionComponent<Props> = ({ doi }) => {
  ...
  const isDMP = doi.types.resourceTypeGeneral === 'OutputManagementPlan'
