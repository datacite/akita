...
export default function WorkFacets({
  ...
  const organizationRelationTypeList: Facet[] = [
    ...
    { id: "createdOrContributedByAffiliatedResearcher", title: "By Affiliated Researchers", tooltipText: "Works created or contributed to by researchers affiliated with the organization.", count: 0 },
    { id: "createdContributedOrPublishedBy", title: "Created By", tooltipText: "Works created, contributed to, or published by the organization.", count: 0 },
